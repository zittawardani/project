  ...
  ({ value, onChange, className, editorContentClassName, ...props }, ref) => {
    ...
    return (
      <div
        ref={ref}
        className={cn(
          'flex h-full min-h-72 w-full flex-col rounded-md border border-input shadow-sm focus-within:border-primary',
          className
        )}
      >
        ...
        <div className="h-full grow" onClick={handleClick}>
          <EditorContent editor={editor} className={cn('minimal-tiptap-editor p-5 h-full', editorContentClassName)} />
        </div>
